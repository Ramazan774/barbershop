                    ...
                    <div className="lg:grid lg:grid-cols-12">
                        ...
                        <div className="relative bg-gradient-to-r from-gray-700 via-gray-900 to-black lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
                            ...
                            <div className="relative mx-auto max-w-md space-y-6 px-6 py-12 sm:max-w-3xl sm:py-16 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
                                <h2 className="text-3xl font-bold tracking-tight text-white" id="join-heading">Elevate Your Grooming Experience</h2>
                                <p className="text-lg text-white">Step into our barbershop, where timeless tradition meets cutting-edge style. Whether you’re looking for a fresh cut or a classic shave, our skilled barbers are here to give you the experience you deserve.</p>
                                <Link href="/contact" className="block w-full rounded-md border border-transparent bg-yellow-500 px-5 py-3 text-center text-base font-bold text-black shadow-lg hover:bg-yellow-400 transition duration-300 sm:inline-block sm:w-auto">Get in touch</Link>
                            </div>
                        </div>
                    </div>
                </div>
