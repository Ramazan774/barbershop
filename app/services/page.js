...
const Services = () => {
  ...
  return (
    <>
      <Head>
        <title>Services | Magico Barbershop</title>
        <meta name="description" content="Explore our range of professional barbering services at Magico Barbershop." />
      </Head>
      <main className="isolate">
        <div className="relative h-96 bg-center bg-cover" style={{ backgroundImage: 'url("/assets/img20.webp")' }}>
          <div className="absolute inset-0 bg-black opacity-75"></div>
          <div className="relative z-10 flex items-center justify-center h-full">
            <h1 className="merienda text-5xl font-bold text-white text-center tracking-tight sm:text-6xl">
              Services We Provide
            </h1>
          </div>
        </div>
